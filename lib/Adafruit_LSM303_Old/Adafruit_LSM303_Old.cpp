...
/***************************************************************************
 CONSTRUCTOR
 ***************************************************************************/
bool Adafruit_LSM303_Old::begin()
{
...
void Adafruit_LSM303_Old::setMagGain(lsm303MagGain gain)
{
...
/***************************************************************************
 PRIVATE FUNCTIONS
 ***************************************************************************/
void Adafruit_LSM303_Old::write8(byte address, byte reg, byte value)
{
...
byte Adafruit_LSM303_Old::read8(byte address, byte reg)
{
  byte value;
